...
{}[https://codeclimate.com/github/lgs/gitkeeper]
...
This is a Rails engine, which has to be mounted on a new or pre-existing Rails 4.0 app. The User model here, is 'name spaced' within gitkeeper_users, as you can see from the following Rails logs :
...
This project rocks and uses MIT-LICENSE.  Copyright © 2013 Luca G. Soave
